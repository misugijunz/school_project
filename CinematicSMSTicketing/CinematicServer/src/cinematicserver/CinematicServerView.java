 ...
 */
public class CinematicServerView extends FrameView {
    
    public CinematicServerView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        cinematicserver.Account a = new cinematicserver.Account();
    ...
    public void deleteRecord() {
        ...
        List<cinematicserver.Account> toRemove = new ArrayList<cinematicserver.Account>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            cinematicserver.Account a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<cinematicserver.Account> merged = new ArrayList<cinematicserver.Account>(list.size());
                for (cinematicserver.Account a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = CinematicServerApp.getApplication().getMainFrame();
            aboutBox = new CinematicServerAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        CinematicServerApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cinematicserver.CinematicServerApp.class).getContext().getResourceMap(CinematicServerView.class);
        ...
        columnBinding.setColumnName("Card Number");
        ...
        nomorHpLabel.setText(resourceMap.getString("nomorHpLabel.text")); // NOI18N
        nomorHpLabel.setName("nomorHpLabel"); // NOI18N

        saldoLabel.setText(resourceMap.getString("saldoLabel.text")); // NOI18N
        saldoLabel.setName("saldoLabel"); // NOI18N
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cardNumber}"), cardNumberField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), cardNumberField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        nomorHpField.setName("nomorHpField"); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(cinematicserver.CinematicServerApp.class).getContext().getActionMap(CinematicServerView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cardNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(nomorHpField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(saldoField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private java.util.List<cinematicserver.Account> list;
